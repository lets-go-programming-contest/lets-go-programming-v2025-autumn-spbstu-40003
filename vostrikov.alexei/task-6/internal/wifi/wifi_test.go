...
import (
	...
	"github.com/lexachanskii/task-6/internal/wifi"
...
func TestWiFiService_GetAddresses(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "success empty",
			setup: func(mock *wifi.MockWiFiHandle) {
				mock.On("Interfaces").Return([]*mywifi.Interface{}, nil)
			},
			want: []net.HardwareAddr{},
		},
		{
			name: "error",
			setup: func(mock *wifi.MockWiFiHandle) {
				mock.On("Interfaces").Return([]*mywifi.Interface(nil), errInterfaces)
			},
